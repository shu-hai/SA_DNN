...
with tf.device('/cpu:0'):
    ...
    model=load_model('training_lr5en4_MNIST_ResNet50_epoch201to250_outlier_dropout_128_best.h5')


parallel_model = multi_gpu_model(model, gpus=2)

checkpoint = MultiGPUCheckpointCallback('training_lr1en4_MNIST_ResNet50_epoch251to300_outlier_dropout_128_best.h5',model, monitor='val_categorical_accuracy', verbose=2, save_best_only=True, mode='max')

logger = CSVLogger("training_lr1en4_MNIST_ResNet50_epoch251to300_outlier_dropout_128_best.log")
history = LossHistory()
