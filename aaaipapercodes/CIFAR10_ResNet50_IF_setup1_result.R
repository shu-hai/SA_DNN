...
for(j in 1:1000)
{
  setup1.train[((j-1)*45+1):(j*45)]=as.matrix(read.table(paste('./result/CIFAR10_ResNet50_128_best_setup1_part',j,'_train.txt',sep='') ))
}
...
write.table(save.data,'setup1_CIFAR10_ResNet50_manhattan.txt',sep=' ',row.names = F,
            col.names = F)

which(setup1.train%in%tail(sort(setup1.train),5))#top 5 with largest FI
#16874 17762 28293 32169 38492
