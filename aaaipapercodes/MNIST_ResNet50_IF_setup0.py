...
# -*- coding: utf-8 -*-
"""
Created on Wed May 16 02:10:16 2018
...
'''
np.savetxt('MNIST_ResNet50_128_best_setup0_part'+ str(set_part) + '_FI_n_outlier.txt', FI_n_outlier, delimiter=' ')
np.savetxt('MNIST_ResNet50_128_best_setup0_part'+ str(set_part) + '_Jacob_n_outlier.txt', Jacob_n_outlier, delimiter=' ')
np.savetxt('MNIST_ResNet50_128_best_setup0_part'+ str(set_part) + '_C_n_outlier.txt', C_n_outlier, delimiter=' ')


np.savetxt('MNIST_ResNet50_128_best_setup0_part'+ str(set_part) + '_FI_outlier.txt', FI_outlier, delimiter=' ')
np.savetxt('MNIST_ResNet50_128_best_setup0_part'+ str(set_part) + '_Jacob_outlier.txt', Jacob_outlier, delimiter=' ')
np.savetxt('MNIST_ResNet50_128_best_setup0_part'+ str(set_part) + '_C_outlier.txt', C_outlier, delimiter=' ')
'''

     

np.savetxt('MNIST_ResNet50_128_best_setup0_FI_n_outlier.txt', FI_n_outlier, delimiter=' ')
np.savetxt('MNIST_ResNet50_128_best_setup0_Jacob_n_outlier.txt', Jacob_n_outlier, delimiter=' ')
#np.savetxt('MNIST_ResNet50_128_best_setup0_C_n_outlier.txt', C_n_outlier, delimiter=' ')


np.savetxt('MNIST_ResNet50_128_best_setup0_FI_outlier.txt', FI_outlier, delimiter=' ')
np.savetxt('MNIST_ResNet50_128_best_setup0_Jacob_outlier.txt', Jacob_outlier, delimiter=' ')
#np.savetxt('MNIST_ResNet50_128_best_setup0_C_outlier.txt', C_outlier, delimiter=' ')
