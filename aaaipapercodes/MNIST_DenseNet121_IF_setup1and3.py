...
y_train_pred = np.load('MNIST_DenseNet121_train_pred_label.npy')# predicted label
...
np.savetxt('MNIST_DenseNet121_128_best_setup1_part'+ str(set_part) + '_train.txt', FI_train, delimiter=' ')
np.savetxt('MNIST_DenseNet121_128_best_setup3_part'+ str(set_part) + '_train.txt', FI_train_pred, delimiter=' ')
np.savetxt('MNIST_DenseNet121_128_best_setup3_part'+ str(set_part) + '_test.txt', FI_test_pred, delimiter=' ')
