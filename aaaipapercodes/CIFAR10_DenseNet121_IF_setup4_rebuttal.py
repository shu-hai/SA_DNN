...
y_test_pred_prob = np.load('CIFAR10_DenseNet121_test_pred_prob.npy')

FI_test= np.loadtxt('setup3_CIFAR10_DenseNet121_test_manhattan.txt')
...
id_maxFI=index[ np.argmax( FI_test[index,0] ) ] #1105


y_test_pred_prob[id_maxFI]#0.50197196
...
np.save('CIFAR10_DenseNet121_128_best_setup4_test_image'+ str(i) + '_multiscale_rebuttal', FI_test_pred)
