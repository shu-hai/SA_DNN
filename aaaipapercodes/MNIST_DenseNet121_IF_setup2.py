...
np.savetxt('MNIST_DenseNet121_128_best_setup2_part'+ str(set_part) +'_all.txt', FI_train_all, delimiter=' ')
np.savetxt('MNIST_DenseNet121_128_best_setup2_part'+ str(set_part) +'_layers.txt', FI_train_layers, delimiter=' ')    
