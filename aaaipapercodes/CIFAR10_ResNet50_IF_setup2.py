...
np.savetxt('CIFAR10_ResNet50_128_best_setup2_part'+ str(set_part) +'_all.txt', FI_train_all, delimiter=' ')
np.savetxt('CIFAR10_ResNet50_128_best_setup2_part'+ str(set_part) +'_layers.txt', FI_train_layers, delimiter=' ')    
