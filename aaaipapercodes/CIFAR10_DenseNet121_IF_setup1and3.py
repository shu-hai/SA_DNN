...
y_train_pred = np.load('CIFAR10_DenseNet121_train_pred_label.npy')# predicted label
...
np.savetxt('CIFAR10_DenseNet121_128_best_setup1_part'+ str(set_part) + '_train.txt', FI_train, delimiter=' ')
np.savetxt('CIFAR10_DenseNet121_128_best_setup3_part'+ str(set_part) + '_train.txt', FI_train_pred, delimiter=' ')
np.savetxt('CIFAR10_DenseNet121_128_best_setup3_part'+ str(set_part) + '_test.txt', FI_test_pred, delimiter=' ')
