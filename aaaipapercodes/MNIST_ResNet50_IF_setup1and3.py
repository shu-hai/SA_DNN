...
np.savetxt('MNIST_ResNet50_128_best_setup1_part'+ str(set_part) + '_train.txt', FI_train, delimiter=' ')
np.savetxt('MNIST_ResNet50_128_best_setup3_part'+ str(set_part) + '_train.txt', FI_train_pred, delimiter=' ')
np.savetxt('MNIST_ResNet50_128_best_setup3_part'+ str(set_part) + '_test.txt', FI_test_pred, delimiter=' ')
