...
checkpoint = MultiGPUCheckpointCallback('training_lr1en4_MNIST_DenseNet121_epoch151to200_dropout_128_best.h5',model, monitor='val_categorical_accuracy', verbose=2, save_best_only=True, mode='max')

logger = CSVLogger("training_lr1en4_MNIST_DenseNet121_epoch151to200_dropout_128_best.log")
history = LossHistory()
