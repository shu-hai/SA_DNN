...
y_test_pred_prob = np.load('MNIST_ResNet50_test_pred_prob.npy')

FI_test= np.loadtxt('setup3_MNIST_ResNet50_test_manhattan.txt')
...
np.save('MNIST_ResNet50_128_best_setup4_test_image'+ str(i) + '_multiscale_rebuttal', FI_test_pred)
